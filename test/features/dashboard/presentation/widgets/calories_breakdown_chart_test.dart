...
import 'package:nutry_flow/features/dashboard/presentation/widgets/calories_breakdown_chart.dart';

void main() {
  group('CaloriesBreakdownChart Tests', () {
    Widget createWidgetUnderTest() {
      return MaterialApp(
        home: Scaffold(
          body: const CaloriesBreakdownChart(),
        ),
      );
    }

    group('Rendering', () {
      testWidgets('should render CaloriesBreakdownChart widget', (WidgetTester tester) async {
        // Arrange
        ...
        // Assert
        expect(find.byType(CaloriesBreakdownChart), findsOneWidget);
      });
