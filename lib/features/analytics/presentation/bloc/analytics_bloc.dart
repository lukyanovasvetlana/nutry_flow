...
class AnalyticsBloc extends Bloc<AnalyticsEvent, AnalyticsState> {
  ...
  Future<void> _onLoadAnalyticsData(
    ...
    try {
      developer.log('📊 AnalyticsBloc: Loading analytics data',
          name: 'AnalyticsBloc');
      ...
      developer.log('📊 AnalyticsBloc: Analytics data loaded successfully',
          name: 'AnalyticsBloc');
    } catch (e) {
      developer.log('📊 AnalyticsBloc: Load analytics data failed: $e',
          name: 'AnalyticsBloc');
  ...
  Future<void> _onLoadNutritionTracking(
    ...
    try {
      developer.log('📊 AnalyticsBloc: Loading nutrition tracking',
          name: 'AnalyticsBloc');
      emit(AnalyticsLoading());
      ...
      developer.log('📊 AnalyticsBloc: Nutrition tracking loaded successfully',
          name: 'AnalyticsBloc');
    } catch (e) {
      developer.log('📊 AnalyticsBloc: Load nutrition tracking failed: $e',
          name: 'AnalyticsBloc');
  ...
  Future<void> _onSaveNutritionTracking(
    ...
    try {
      developer.log('📊 AnalyticsBloc: Saving nutrition tracking',
          name: 'AnalyticsBloc');
      emit(AnalyticsLoading());
      ...
      developer.log('📊 AnalyticsBloc: Nutrition tracking saved successfully',
          name: 'AnalyticsBloc');
    } catch (e) {
      developer.log('📊 AnalyticsBloc: Save nutrition tracking failed: $e',
          name: 'AnalyticsBloc');
  ...
  Future<void> _onLoadWeightTracking(
    ...
    try {
      developer.log('📊 AnalyticsBloc: Loading weight tracking',
          name: 'AnalyticsBloc');
      emit(AnalyticsLoading());
      ...
      developer.log('📊 AnalyticsBloc: Weight tracking loaded successfully',
          name: 'AnalyticsBloc');
    } catch (e) {
      developer.log('📊 AnalyticsBloc: Load weight tracking failed: $e',
          name: 'AnalyticsBloc');
  ...
  Future<void> _onSaveWeightTracking(
    ...
    try {
      developer.log('📊 AnalyticsBloc: Saving weight tracking',
          name: 'AnalyticsBloc');
      emit(AnalyticsLoading());
      ...
      developer.log('📊 AnalyticsBloc: Weight tracking saved successfully',
          name: 'AnalyticsBloc');
    } catch (e) {
      developer.log('📊 AnalyticsBloc: Save weight tracking failed: $e',
          name: 'AnalyticsBloc');
  ...
  Future<void> _onLoadActivityTracking(
    ...
    try {
      developer.log('📊 AnalyticsBloc: Loading activity tracking',
          name: 'AnalyticsBloc');
      emit(AnalyticsLoading());
      ...
      developer.log('📊 AnalyticsBloc: Activity tracking loaded successfully',
          name: 'AnalyticsBloc');
    } catch (e) {
      developer.log('📊 AnalyticsBloc: Load activity tracking failed: $e',
          name: 'AnalyticsBloc');
  ...
  Future<void> _onSaveActivityTracking(
    ...
    try {
      developer.log('📊 AnalyticsBloc: Saving activity tracking',
          name: 'AnalyticsBloc');
      emit(AnalyticsLoading());
      ...
      developer.log('📊 AnalyticsBloc: Activity tracking saved successfully',
          name: 'AnalyticsBloc');
    } catch (e) {
      developer.log('📊 AnalyticsBloc: Save activity tracking failed: $e',
          name: 'AnalyticsBloc');
  ...
  Future<void> _onLoadAnalyticsSummary(
    ...
    try {
      developer.log('📊 AnalyticsBloc: Loading analytics summary',
          name: 'AnalyticsBloc');
      emit(AnalyticsLoading());
      ...
      final nutritionTracking =
          await _analyticsRepository.getNutritionTracking(startDate, endDate);
      final weightTracking =
          await _analyticsRepository.getWeightTracking(startDate, endDate);
      final activityTracking =
          await _analyticsRepository.getActivityTracking(startDate, endDate);
      ...
      developer.log('📊 AnalyticsBloc: Analytics summary loaded successfully',
          name: 'AnalyticsBloc');
    } catch (e) {
      developer.log('📊 AnalyticsBloc: Load analytics summary failed: $e',
          name: 'AnalyticsBloc');
  ...
  Future<void> _onTrackAnalyticsEvent(
    ...
    try {
      developer.log('📊 AnalyticsBloc: Tracking analytics event',
          name: 'AnalyticsBloc');
      emit(AnalyticsLoading());
      ...
      developer.log('📊 AnalyticsBloc: Analytics event tracked successfully',
          name: 'AnalyticsBloc');
    } catch (e) {
      developer.log('📊 AnalyticsBloc: Track analytics event failed: $e',
          name: 'AnalyticsBloc');
  ...
  Map<String, dynamic> _calculateSummary(
    ...
    // Общая активность
    final totalSteps =
        activityTracking.map((a) => a.stepsCount).reduce((a, b) => a + b);
    final totalCaloriesBurned =
        activityTracking.map((a) => a.caloriesBurned).reduce((a, b) => a + b);

    // Средний белок за день
    final avgProtein = nutritionTracking.isNotEmpty
        ? nutritionTracking
                .map((n) => n.proteinConsumed)
                .reduce((a, b) => a + b) /
            nutritionTracking.length
        : 0;
    ...
    return {
      ...
      'workoutSessions':
          activityTracking.where((a) => a.workoutDuration > 0).length,
    };
  }
}
