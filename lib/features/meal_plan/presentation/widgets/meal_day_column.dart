...
class MealDayColumn extends StatelessWidget {
  ...
  const MealDayColumn(
      {required this.day, required this.selectedMealType, super.key});
  ...
  Widget _getMealCard(BuildContext context) {
    switch (selectedMealType) {
      case 'Завтрак':
        return MealCard(
            type: 'Завтрак', color: context.primary, title: _breakfasts[day]);
      case 'Обед':
        return MealCard(
            type: 'Обед', color: context.warning, title: _lunches[day]);
      case 'Перекус':
        return MealCard(
            type: 'Перекус',
            color: context.onSurfaceVariant,
      ...
      case 'Ужин':
        return MealCard(
            type: 'Ужин', color: context.tertiary, title: _dinners[day]);
      default:
        return MealCard(
            type: 'Завтрак', color: context.primary, title: _breakfasts[day]);
    }
