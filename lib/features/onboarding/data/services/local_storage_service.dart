...
class LocalStorageService {
  ...
  Future<bool> saveUserGoals(Map<String, dynamic> goals, String userId) async {
    ...
    return await _prefs.setString(key, goalsJson);
  }
  ...
  Future<bool> saveUserProfile(Map<String, dynamic> profile, String userId) async {
    final key = '${_userProfileKey}_$userId';
    final profileJson = jsonEncode(profile);
    return await _prefs.setString(key, profileJson);
  }
