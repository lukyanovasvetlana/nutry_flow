...
class OnboardingDependencies {
  ...
  Future<void> initialize() async {
    ...
    print('🟣 OnboardingDependencies: Checking demo mode - SupabaseConfig.isDemo = ${SupabaseConfig.isDemo}');
    
    if (SupabaseConfig.isDemo) {
      print('🟣 OnboardingDependencies: Using MockUserGoalsRepository');
      _userGoalsRepository = MockUserGoalsRepository();
      
      print('🟣 OnboardingDependencies: Using MockAuthRepository');
      _authRepository = MockAuthRepository();
      // Создаем тестового пользователя для демонстрации
      MockAuthRepository.createTestUser();
      print('🟣 OnboardingDependencies: Test user created');
    } else {
      print('🟣 OnboardingDependencies: Using UserGoalsRepositoryImpl');
      _userGoalsRepository = UserGoalsRepositoryImpl(
        _supabaseService,
        _localStorageService,
      );
      
      print('🟣 OnboardingDependencies: Using AuthRepositoryImpl');
  ...
  AuthBloc createAuthBloc() {
    ...
    print('🟣 OnboardingDependencies: _authRepository type: ${_authRepository.runtimeType}');
    print('🟣 OnboardingDependencies: _signUpUseCase type: ${_signUpUseCase.runtimeType}');
    print('🟣 OnboardingDependencies: _signInUseCase type: ${_signInUseCase.runtimeType}');
